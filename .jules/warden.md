...
Alignment / Deferred:
Appended release notes to CHANGELOG.md specifying the CPU performance improvement. Safely bumped `dotenv` dependency to version `17.4.0`. Re-ran tests and verified survival without issue. Version bumped to 1.1.5.
